...
import { statSync, mkdirSync, existsSync, realpathSync } from "node:fs";
...
// files — nothing is held open here. The pure helpers (parseMetaBlock,
// assertTaskId, resolveTaskState, shQuote, buildConnConfig) live in lib.js.
// ---------------------------------------------------------------------------
...
/** True when this file was run directly (`node index.js`), not imported. */
